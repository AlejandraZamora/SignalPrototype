...
angular.module('myApp.RegisterDoctorViewArmAngles', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/RegisterDoctorViewArmAngles', {
    templateUrl: 'RegisterDoctorViewArmAngles/RegisterDoctorViewArmAngles.html',
    controller: 'RegisterDoctorViewArmAnglesCtrl'
  });
}])

.controller('RegisterDoctorViewArmAnglesCtrl', ['$rootScope', '$scope', 'patient', 'patients', function ($rootScope, $scope, patient, patients) {
    ...
    .$promise.then(
            ...
            function( value ){
                ...
                $scope.diagnostics=$scope.principal.armAngles;
$scope.upperAngle=[];
$scope.lowerAngle=[];
				$scope.diagnosticsNew=[];
                $scope.labels=[];
                $scope.series = ['Datos de Control ArmAngles'];
